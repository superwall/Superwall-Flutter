...
public class SuperwallDelegateProxyBridge: BridgeInstance, SuperwallDelegate {
  ...
  public func willPresentPaywall(withInfo paywallInfo: PaywallInfo) {
    communicator.invokeMethodOnMain(
      "willPresentPaywall", arguments: ["paywallInfoBridgeId": paywallInfo.createBridgeId()])
  }

  public func didPresentPaywall(withInfo paywallInfo: PaywallInfo) {
    communicator.invokeMethodOnMain(
      "didPresentPaywall", arguments: ["paywallInfoBridgeId": paywallInfo.createBridgeId()])
  }

  public func willDismissPaywall(withInfo paywallInfo: PaywallInfo) {
    communicator.invokeMethodOnMain(
      "willDismissPaywall", arguments: ["paywallInfoBridgeId": paywallInfo.createBridgeId()])
  }

  public func didDismissPaywall(withInfo paywallInfo: PaywallInfo) {
    communicator.invokeMethodOnMain(
      "didDismissPaywall", arguments: ["paywallInfoBridgeId": paywallInfo.createBridgeId()])
  }
  ...
  public func subscriptionStatusDidChange(
    ...
    communicator.invokeMethodOnMain(
      ...
      arguments: ["subscriptionStatusBridgeId": newValue.createBridgeId()])
  }

  public func handleSuperwallEvent(withInfo eventInfo: SuperwallEventInfo) {
    communicator.invokeMethodOnMain(
      "handleSuperwallEvent", arguments: ["eventInfo": eventInfo.toJson()])
  }
  ...
  public func paywallWillOpenDeepLink(url: URL) {
    communicator.invokeMethodOnMain(
      "paywallWillOpenDeepLink", arguments: ["url": url.absoluteString])
  }
