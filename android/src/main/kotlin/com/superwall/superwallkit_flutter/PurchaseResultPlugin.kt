...
class PurchaseResultPlugin : FlutterPlugin, MethodCallHandler {
    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        if (call.method == "isEqualTo") {
            ...
            if (result1 != null && result2 != null) {
                // TODO: Implement equality logic here based on the result1 and result2 strings
                // and the optional data associated with them if necessary.
                val isEqual = (result1 == result2)
