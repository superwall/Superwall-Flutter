...
enum class PTestModeBehavior(val raw: Int) {
  ...
  companion object {
    fun ofRaw(raw: Int): PTestModeBehavior? {
...
enum class PEventTrackingBehavior(val raw: Int) {
  ...
  companion object {
    fun ofRaw(raw: Int): PEventTrackingBehavior? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}
...
enum class PCustomCallbackResultStatus(val raw: Int) {
  ...
  companion object {
    fun ofRaw(raw: Int): PCustomCallbackResultStatus? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}
...
enum class PIntegrationAttribute(val raw: Int) {
  ...
  SINGULAR_DEVICE_ID(1),
  /** The Amplitude device identifier. */
  AMPLITUDE_DEVICE_ID(2),
...
data class PSuperwallOptions (
  ...
  val eventTrackingBehavior: PEventTrackingBehavior? = null,
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PSuperwallOptions {
      ...
      val eventTrackingBehavior = pigeonVar_list[2] as PEventTrackingBehavior?
      val isExternalDataCollectionEnabled = pigeonVar_list[3] as Boolean?
      val localeIdentifier = pigeonVar_list[4] as String?
      val isGameControllerEnabled = pigeonVar_list[5] as Boolean?
      val enableExperimentalDeviceVariables = pigeonVar_list[6] as Boolean?
      val logging = pigeonVar_list[7] as PLogging?
      val passIdentifiersToPlayStore = pigeonVar_list[8] as Boolean?
      val testModeBehavior = pigeonVar_list[9] as PTestModeBehavior?
      val shouldObservePurchases = pigeonVar_list[10] as Boolean?
      val shouldBypassAppTransactionCheck = pigeonVar_list[11] as Boolean?
      val maxConfigRetryCount = pigeonVar_list[12] as Long?
      val useMockReviews = pigeonVar_list[13] as Boolean?
      return PSuperwallOptions(paywalls, networkEnvironment, eventTrackingBehavior, isExternalDataCollectionEnabled, localeIdentifier, isGameControllerEnabled, enableExperimentalDeviceVariables, logging, passIdentifiersToPlayStore, testModeBehavior, shouldObservePurchases, shouldBypassAppTransactionCheck, maxConfigRetryCount, useMockReviews)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PPaywallInfo {
      ...
      val state = pigeonVar_list[30] as Map<String, Any>?
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PPaywallOptions {
      ...
      val loadingColor = pigeonVar_list[11] as Long?
      return PPaywallOptions(isHapticFeedbackEnabled, restoreFailed, shouldShowPurchaseFailureAlert, shouldPreload, automaticallyDismiss, shouldShowWebRestorationAlert, transactionBackgroundView, overrideProductsByName, shouldShowWebPurchaseConfirmationAlert, onBackPressedHost, preloadDeviceOverrides, loadingColor)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
data class PCustomCallback (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PCustomCallback {
      val name = pigeonVar_list[0] as String
      val variables = pigeonVar_list[1] as Map<String, Any>?
      return PCustomCallback(name, variables)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class PCustomCallbackResult (
  /** Whether the callback succeeded or failed. */
  val status: PCustomCallbackResultStatus,
  /** Optional key-value pairs to return to the paywall. */
  val data: Map<String, Any>? = null
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PCustomCallbackResult {
      val status = pigeonVar_list[0] as PCustomCallbackResultStatus
      val data = pigeonVar_list[1] as Map<String, Any>?
      return PCustomCallbackResult(status, data)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is PCustomCallbackResult) {
      return false
    }
    if (this === other) {
      return true
...
private open class SuperwallHostGeneratedPigeonCodec : StandardMessageCodec() {
    ...
    return when (type) {
      129.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
          PTestModeBehavior.ofRaw(it.toInt())
        }
      }
      130.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
          PEventTrackingBehavior.ofRaw(it.toInt())
        }
      }
      131.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?)   {
    when (value) {
      is PTestModeBehavior -> {
        stream.write(129)
        writeValue(stream, value.raw.toLong())
      }
      is PEventTrackingBehavior -> {
        stream.write(130)
        writeValue(stream, value.raw.toLong())
      }
  ...
  fun onSkip(reasonArg: PPaywallSkippedReason, callback: (Result<Unit>) -> Unit)
{
   ...
   */
  fun onCustomCallback(callbackArg: PCustomCallback, callback: (Result<PCustomCallbackResult>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.superwallkit_flutter.PPaywallPresentationHandlerGenerated.onCustomCallback$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(callbackArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else if (it[0] == null) {
...
// Implement methods from SuperwallHostGeneratedPigeonEventChannelWrapper
...
// Implement methods from SuperwallHostGeneratedPigeonEventChannelWrapper
override fun onListen(p0: Any?, sink: PigeonEventSink<PCustomerInfo>) {}
