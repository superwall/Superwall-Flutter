...
struct PSuperwallOptions: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PSuperwallOptions? {
    ...
    let testModeBehavior: PTestModeBehavior? = nilOrValue(pigeonVar_list[8])
    let shouldObservePurchases: Bool? = nilOrValue(pigeonVar_list[9])
