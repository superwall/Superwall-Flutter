...
enum class PEventType(val raw: Int) {
  ...
  STRIPE_CHECKOUT_START(73),
  STRIPE_CHECKOUT_SUBMIT(74),
  STRIPE_CHECKOUT_COMPLETE(75),
  STRIPE_CHECKOUT_FAIL(76),
  TEST_MODE_MODAL_OPEN(77),
  TEST_MODE_MODAL_CLOSE(78);
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PSuperwallOptions {
      ...
      val testModeBehavior = pigeonVar_list[8] as PTestModeBehavior?
      return PSuperwallOptions(paywalls, networkEnvironment, isExternalDataCollectionEnabled, localeIdentifier, isGameControllerEnabled, enableExperimentalDeviceVariables, logging, passIdentifiersToPlayStore, testModeBehavior)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
