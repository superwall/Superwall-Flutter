...
extension PSuperwallOptions {
  func toSdkOptions() -> SuperwallOptions {
    ...
    if let paywalls = self.paywalls {
      ...
      if let shouldShowWebRestorationAlert = paywalls.shouldShowWebRestorationAlert {
        options.paywalls.shouldShowWebRestorationAlert = shouldShowWebRestorationAlert
      }
    ...
    if let enableExperimentalDeviceVariables = self.enableExperimentalDeviceVariables {
      options.enableExperimentalDeviceVariables = enableExperimentalDeviceVariables
    }
