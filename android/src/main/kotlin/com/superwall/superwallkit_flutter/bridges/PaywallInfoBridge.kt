    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        scope.launch {
            ...
            when (call.method) {
                ...
                "getPresentedByPlacementWithName" -> result.success(paywallInfo.presentedByEventWithName)
                "getPresentedByPlacementWithId" -> result.success(paywallInfo.presentedByEventWithId)
                "getPresentedByPlacementAt" -> result.success(paywallInfo.presentedByEventAt)
