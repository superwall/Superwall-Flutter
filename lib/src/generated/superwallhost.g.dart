...
class PSuperwallOptions {
  ...
  static PSuperwallOptions decode(Object result) {
    ...
    return PSuperwallOptions(
      ...
      eventTrackingBehavior: result[2] as PEventTrackingBehavior?,
      isExternalDataCollectionEnabled: result[3] as bool?,
      localeIdentifier: result[4] as String?,
      isGameControllerEnabled: result[5] as bool?,
      enableExperimentalDeviceVariables: result[6] as bool?,
      logging: result[7] as PLogging?,
      passIdentifiersToPlayStore: result[8] as bool?,
      testModeBehavior: result[9] as PTestModeBehavior?,
      shouldObservePurchases: result[10] as bool?,
      shouldBypassAppTransactionCheck: result[11] as bool?,
      maxConfigRetryCount: result[12] as int?,
      useMockReviews: result[13] as bool?,
    );
  }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    }    else if (value is PEventTrackingBehavior) {
      buffer.putUint8(130);
      writeValue(buffer, value.index);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 130: 
        final value = readValue(buffer) as int?;
        return value == null ? null : PEventTrackingBehavior.values[value];
      case 131: 
        final value = readValue(buffer) as int?;
