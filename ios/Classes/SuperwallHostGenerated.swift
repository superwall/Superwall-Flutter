...
enum PEventTrackingBehavior: Int {
...
enum PEntitlementType: Int {
  case serviceLevel = 0
}

/// The state of a subscription.
enum PLatestSubscriptionState: Int {
...
enum PLatestSubscriptionOfferType: Int {
  case trial = 0
  case code = 1
  case promotional = 2
  case winback = 3
...
struct PSuperwallOptions: Hashable {
  ...
  var eventTrackingBehavior: PEventTrackingBehavior? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PSuperwallOptions? {
    ...
    let eventTrackingBehavior: PEventTrackingBehavior? = nilOrValue(pigeonVar_list[2])
    let isExternalDataCollectionEnabled: Bool? = nilOrValue(pigeonVar_list[3])
    let localeIdentifier: String? = nilOrValue(pigeonVar_list[4])
    let isGameControllerEnabled: Bool? = nilOrValue(pigeonVar_list[5])
    let enableExperimentalDeviceVariables: Bool? = nilOrValue(pigeonVar_list[6])
    let logging: PLogging? = nilOrValue(pigeonVar_list[7])
    let passIdentifiersToPlayStore: Bool? = nilOrValue(pigeonVar_list[8])
    let testModeBehavior: PTestModeBehavior? = nilOrValue(pigeonVar_list[9])
    let shouldObservePurchases: Bool? = nilOrValue(pigeonVar_list[10])
    let shouldBypassAppTransactionCheck: Bool? = nilOrValue(pigeonVar_list[11])
    let maxConfigRetryCount: Int64? = nilOrValue(pigeonVar_list[12])
    let useMockReviews: Bool? = nilOrValue(pigeonVar_list[13])
...
struct PPaywallInfo: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PPaywallInfo? {
    ...
    let state: [String: Any]? = nilOrValue(pigeonVar_list[30])
...
struct PPaywallOptions: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PPaywallOptions? {
    ...
    let loadingColor: Int64? = nilOrValue(pigeonVar_list[11])
...
/// Generated class from Pigeon that represents data sent in messages.
struct POnBackPressedHost: Hashable {
  var hostId: String? = nil


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> POnBackPressedHost? {
  ...
  static func == (lhs: POnBackPressedHost, rhs: POnBackPressedHost) -> Bool {
    return deepEqualsSuperwallHostGenerated(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashSuperwallHostGenerated(value: toList(), hasher: &hasher)
  }
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct PCustomCallback: Hashable {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PCustomCallback? {
    let name = pigeonVar_list[0] as! String
    let variables: [String: Any]? = nilOrValue(pigeonVar_list[1])
  ...
  static func == (lhs: PCustomCallback, rhs: PCustomCallback) -> Bool {
    return deepEqualsSuperwallHostGenerated(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashSuperwallHostGenerated(value: toList(), hasher: &hasher)
  }
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct PCustomCallbackResult: Hashable {
  /// Whether the callback succeeded or failed.
  var status: PCustomCallbackResultStatus
  /// Optional key-value pairs to return to the paywall.
  var data: [String: Any]? = nil


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PCustomCallbackResult? {
    let status = pigeonVar_list[0] as! PCustomCallbackResultStatus
  ...
  static func == (lhs: PCustomCallbackResult, rhs: PCustomCallbackResult) -> Bool {
    return deepEqualsSuperwallHostGenerated(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashSuperwallHostGenerated(value: toList(), hasher: &hasher)
  }
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct PSubscriptionTransaction: Hashable {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PSubscriptionTransaction? {
    ...
    let willRenew = pigeonVar_list[3] as! Bool
    let isRevoked = pigeonVar_list[4] as! Bool
    let isInGracePeriod = pigeonVar_list[5] as! Bool
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct PNonSubscriptionTransaction: Hashable {
  /// The unique identifier for the transaction.
  var transactionId: String
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PNonSubscriptionTransaction? {
    let transactionId = pigeonVar_list[0] as! String
    let productId = pigeonVar_list[1] as! String
    let purchaseDate = pigeonVar_list[2] as! Int64
...
struct PEntitlement: Hashable {
  ...
  var state: PLatestSubscriptionState? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PEntitlement? {
    let id = pigeonVar_list[0] as! String
    let type = pigeonVar_list[1] as! PEntitlementType
    let isActive = pigeonVar_list[2] as! Bool
    let productIds = pigeonVar_list[3] as! [String]
    let latestProductId: String? = nilOrValue(pigeonVar_list[4])
    let store: PProductStore? = nilOrValue(pigeonVar_list[5])
    let startsAt: Int64? = nilOrValue(pigeonVar_list[6])
    let renewedAt: Int64? = nilOrValue(pigeonVar_list[7])
    let expiresAt: Int64? = nilOrValue(pigeonVar_list[8])
    let isLifetime: Bool? = nilOrValue(pigeonVar_list[9])
    let willRenew: Bool? = nilOrValue(pigeonVar_list[10])
    let state: PLatestSubscriptionState? = nilOrValue(pigeonVar_list[11])
    let offerType: PLatestSubscriptionOfferType? = nilOrValue(pigeonVar_list[12])
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct PCustomerInfo: Hashable {
  /// The subscription transactions the user has made.
  var subscriptions: [PSubscriptionTransaction]
  /// The non-subscription transactions the user has made.
  var nonSubscriptions: [PNonSubscriptionTransaction]
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PCustomerInfo? {
    let subscriptions = pigeonVar_list[0] as! [PSubscriptionTransaction]
    let nonSubscriptions = pigeonVar_list[1] as! [PNonSubscriptionTransaction]
  ...
  static func == (lhs: PCustomerInfo, rhs: PCustomerInfo) -> Bool {
    return deepEqualsSuperwallHostGenerated(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashSuperwallHostGenerated(value: toList(), hasher: &hasher)
  }
...
struct PEntitlements: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PEntitlements? {
    ...
    let web = pigeonVar_list[3] as! [PEntitlement]
...
struct PSuperwallEventInfo: Hashable {
  ...
  var message: String? = nil
  var integrationAttributes: [String: Any]? = nil
  var reviewRequestedCount: Int64? = nil
  var missingProductIdentifiers: [String]? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PSuperwallEventInfo? {
    ...
    let integrationAttributes: [String: Any]? = nilOrValue(pigeonVar_list[24])
    let reviewRequestedCount: Int64? = nilOrValue(pigeonVar_list[25])
    let missingProductIdentifiers: [String]? = nilOrValue(pigeonVar_list[26])
  ...
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 129:
      ...
      if let enumResultAsInt = enumResultAsInt {
        return PTestModeBehavior(rawValue: enumResultAsInt)
      }
      return nil
    case 130:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return PEventTrackingBehavior(rawValue: enumResultAsInt)
      }
      return nil
    case 131:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
...
private class SuperwallHostGeneratedPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? PTestModeBehavior {
      super.writeByte(129)
      super.writeValue(value.rawValue)
    } else if let value = value as? PEventTrackingBehavior {
      super.writeByte(130)
      super.writeValue(value.rawValue)
    } else if let value = value as? PFeatureGatingBehavior {
      super.writeByte(131)
      super.writeValue(value.rawValue)
...
protocol PSuperwallHostApi {
  ...
  func setIntegrationAttribute(attribute: PIntegrationAttribute, value: String?) throws
...
class PSuperwallHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: PSuperwallHostApi?, messageChannelSuffix: String = "") {
    ...
    let setIntegrationAttributeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.superwallkit_flutter.PSuperwallHostApi.setIntegrationAttribute\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setIntegrationAttributeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let attributeArg = args[0] as! PIntegrationAttribute
        let valueArg: String? = nilOrValue(args[1])
        do {
          try api.setIntegrationAttribute(attribute: attributeArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setIntegrationAttributeChannel.setMessageHandler(nil)
    }
    let setIntegrationAttributesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.superwallkit_flutter.PSuperwallHostApi.setIntegrationAttributes\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setIntegrationAttributesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let attributesArg = args[0] as? [PIntegrationAttribute: String?]
        do {
          try api.setIntegrationAttributes(attributes: attributesArg!)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setIntegrationAttributesChannel.setMessageHandler(nil)
    }
    ...
    if let api = api {
      getCustomerInfoChannel.setMessageHandler { _, reply in
        api.getCustomerInfo { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getCustomerInfoChannel.setMessageHandler(nil)
    }
...
protocol PPaywallPresentationHandlerGeneratedProtocol {
  ...
  func onCustomCallback(callback callbackArg: PCustomCallback, completion: @escaping (Result<PCustomCallbackResult, PigeonError>) -> Void)
}
class PPaywallPresentationHandlerGenerated: PPaywallPresentationHandlerGeneratedProtocol {
  ...
  /// Returns a result indicating success/failure with optional data.
  func onCustomCallback(callback callbackArg: PCustomCallback, completion: @escaping (Result<PCustomCallbackResult, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.superwallkit_flutter.PPaywallPresentationHandlerGenerated.onCustomCallback\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([callbackArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
...
/// Generated protocol from Pigeon that represents Flutter messages that can be called from Swift.
protocol POnBackPressedGeneratedProtocol {
  func onBackPressed(paywallInfo paywallInfoArg: PPaywallInfo?, completion: @escaping (Result<Void, PigeonError>) -> Void)
}
class POnBackPressedGenerated: POnBackPressedGeneratedProtocol {
  private let binaryMessenger: FlutterBinaryMessenger
  private let messageChannelSuffix: String
  init(binaryMessenger: FlutterBinaryMessenger, messageChannelSuffix: String = "") {
    self.binaryMessenger = binaryMessenger
  ...
  func onBackPressed(paywallInfo paywallInfoArg: PPaywallInfo?, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.superwallkit_flutter.POnBackPressedGenerated.onBackPressed\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([paywallInfoArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
...
class StreamSubscriptionStatusStreamHandler: PigeonEventChannelWrapper<PSubscriptionStatus> {
  static func register(with messenger: FlutterBinaryMessenger,
    ...
    var channelName = "dev.flutter.pigeon.superwallkit_flutter.SuperwallEventStreams.streamSubscriptionStatus"
...
class StreamCustomerInfoStreamHandler: PigeonEventChannelWrapper<PCustomerInfo> {
  static func register(with messenger: FlutterBinaryMessenger,
                      instanceName: String = "",
                      streamHandler: StreamCustomerInfoStreamHandler) {
    var channelName = "dev.flutter.pigeon.superwallkit_flutter.SuperwallEventStreams.streamCustomerInfo"
    if !instanceName.isEmpty {
      channelName += ".\(instanceName)"
    }
    let internalStreamHandler = PigeonStreamHandler<PCustomerInfo>(wrapper: streamHandler)
    let channel = FlutterEventChannel(name: channelName, binaryMessenger: messenger, codec: superwallHostGeneratedPigeonMethodCodec)
    channel.setStreamHandler(internalStreamHandler)
  }
}
